...
% 	Rackspace
	...
	\headerrow
		...
		{\href{https://www.rackspace.com/}{\textbf{Rackspace Inc, Hyderabad}}}
	\\
	\headerrow
	...
	\begin{itemize*}
        ...
        \item As a member of {\href{https://www.objectrocket.com/}{ObjectRocket}} team built the platform APIs for new databases such as CockroachDB and MongoDB.
	\end{itemize*}
...
\hyphenpenalty=1000
\begin{description*}
    Python, Go, JavaScript, Flask, React, Redux, GraphQL, PostgreSQL, Docker
%     \item[Proficient:]
