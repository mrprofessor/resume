...
\begin{itemize}
	...
	\begin{itemize*}
		...
		\item Currently working as a Python developer building dynamic retail applications.
		\item Implemented Role Based Access Control for users and groups which is being used by at least 100,000 users.
...
\begin{description*}
% 	\item[Strong:]
% 	JavaScript, React, Express, Git, AWS
% 	\item[Knowledgeable:]
% 	Node.js, Graphql, Redux, Python, GCP, Azure, MongoDB
